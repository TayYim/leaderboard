...
#world = client.load_world('Town04') # change the map name you need
...
for w in waypoints:
    ...
    print(w_location)
    text = '({},{}-{})'.format(round(w_location.x, 2), round(w_location.y, 2), round(w_rotation.yaw, 2))
    #text = str(w.transform)
